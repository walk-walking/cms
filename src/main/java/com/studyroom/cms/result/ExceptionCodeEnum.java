...
public enum ExceptionCodeEnum {
    ...
    DELETE_UNRULED_OR_INVALID_SEAT_FAIL(50003,"未设置预约规则或者自习室不可用的座位删除失败"),
    ...
    GET_EFFECT_ROOM_BY_TIME_FAIL(50009,"根据预约开始/结束时间获取规则已生效的自习室失败"),
    ...
    GET_VALID_STUDY_ROOM_FAIL(50017,"未能成功获取可用的自习室");
